...
public class DiscordEcho
{
    ...
    public static void writeToFile(Guild guild, int time, TextChannel tc) {
        ...
        try {
            ...
            dest = new File("C:\\Users\\Ryan\\Documents\\Echo\\recordings\\" + getPJSaltString() + ".mp3");
    ...
    //TODO -- global properties for file directory
    public static String getPJSaltString() {
        ...
        //TODO -- name by timestamp instead
        File dir = new File("C:\\Users\\Ryan\\Documents\\Echo\\recordings");
